...
|------------|------------|-----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.8.0-rc.9 | 2026-05-01 | [](https://github.com/airbytehq/airbyte/pull/) | Classify SocketTimeoutException and connection attempt failures as transient errors for automatic retry |
